...
CREATE TABLE `chitiet_giohang` (
  ...
  PRIMARY KEY (`id`),
  KEY `giohangID_idx` (`giohangID`),
  KEY `sanphamID_idx` (`sanphamID`),
  CONSTRAINT `giohangID` FOREIGN KEY (`giohangID`) REFERENCES `giohang` (`id`),
  CONSTRAINT `sanphamID_` FOREIGN KEY (`sanphamID`) REFERENCES `sanpham` (`id`)
