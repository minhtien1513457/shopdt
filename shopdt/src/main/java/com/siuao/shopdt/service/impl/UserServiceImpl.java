...
public class UserServiceImpl implements UserService {
    ...
    private <T extends Object, R extends Object> void setPagingResult(Paging<R> res, Page<T> data, Integer page, Integer size) {
        res.setPage(page);
    ...
    public boolean deleteUser(Long userActionId, Long userId) {
       User userAction = userDao.findById(userActionId).orElse(null);
       User user = userDao.findById(userId).orElse(null);
        if(userAction != null){
          if(userAction.getRole().equals(ERole.ROLE_ADMIN)) {
            userDao.delete(user);
            return true;
          }
          else return false;
    ...
    @Override
    public Boolean updateUser(UpdateUserRequest req) throws Exception {
